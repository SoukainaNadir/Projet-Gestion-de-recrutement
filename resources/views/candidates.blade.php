...
<body class="bg-[#F9AF16] font-Inconsolata">
    ...
    <tr class="border-b border-gray-200 hover:bg-gray-100">
        ...
        <td class="py-3 px-6 text-left">{{ $apply->created_at->format('Y-m-d H:i:s') }}</td>
        <td class="py-3 px-6 text-left"><a href="" class="text-blue-500"></a></td>
        <td class="py-3 px-6 text-center">
            ...
            <a href="" class="mr-3 text-sm bg-green-500 hover:bg-green-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline-blue" title="Download"><i class="fas fa-download"></i></a>
