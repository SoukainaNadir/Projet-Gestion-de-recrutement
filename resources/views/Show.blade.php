            ...
            <div class="p-8 ">
                ...
                <div class="mt-4">
                    ...
                    <div class="mr-4 mb-2">
                        ...
                        <span class="ml-2 text-gray-500">{{ $offer->location }}</span>
                    </div>
                ...
                <div class="mt-8">
                    ...
                    <div id="form-container" class="w-[32%] fixed z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-4 rounded-md shadow-lg hidden">
                        ...
                        <form action="{{ route('job.save') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                            ...
                            <div class="flex flex-col space-y-2">
                                ...
                                <div class="flex items-center space-x-2">
                                  ...
                                  <input type="text" id="cv-file-name" name="cv-file-name" class="w-[74%] border-gray-300 border-solid border-2 px-4 py-2 rounded-lg focus:outline-none focus:border-gary-500" readonly>
                                </div>
                            ...
                            <div class="flex flex-col space-y-2">
                              ...
                              <div class="flex items-center space-x-2">
                                ...
                                <input type="text" id="cover-letter-file-name" name="cover-letter-file-name" class=" w-[74%] border-gray-300 border-solid border-2 px-4 py-2 rounded-lg focus:outline-none focus:border-gary-500" readonly>
                            </div>
                ...
                <div class=" absolute top-4 right-4 mt-4 flex items-center space-x-2">
